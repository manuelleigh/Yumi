...
class Informe_Model extends Model
{
    ...
    public function venta_fpago_list($data)
    {
        try
        {
            ...
            if ($id_tipo_pago == 1) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar+v.pago_bil+v.pago_tra+v.pago_lin),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.id_tpag LIKE ? AND v.estado = 'a' OR v.pago_efe!=0 GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha,$data['id_tpag']));    
            }            

            if ($id_tipo_pago == 9) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_mastercard>0 AND v.estado = 'a' OR v.id_tpag ='9' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 2) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_visa>0 AND v.estado = 'a' OR v.id_tpag ='2' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 4) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_lin>0 AND v.estado = 'a' OR v.id_tpag ='4' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 7) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_tra>0 AND v.estado = 'a' OR v.id_tpag ='7' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 6) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_lukita>0 AND v.estado = 'a' OR v.id_tpag ='6' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 8) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_plin>0 AND v.estado = 'a' OR v.id_tpag ='8' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 16) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_tunki>0 AND v.estado = 'a' OR v.id_tpag ='16' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }

            if ($id_tipo_pago == 5) {
                $stm = $this->db->prepare("SELECT v.id_ven,v.id_ped,v.id_tpag,v.pago_efe,v.pago_tar,v.pago_bil,v.pago_tra,v.pago_lin,v.pago_mastercard,v.pago_visa,v.pago_lukita,v.pago_plin,v.pago_tunki,v.pago_yape,v.desc_monto,v.comis_tar,v.comis_del,v.total AS stotal,v.total_completo AS total_completo,v.fec_ven,v.desc_td,CONCAT(v.ser_doc,'-',v.nro_doc) AS numero,IFNULL(SUM(v.pago_efe+v.pago_tar),0) AS total,v.id_cli,v.igv,v.id_usu,c.desc_caja,v.estado,v.codigo_operacion FROM v_ventas_con AS v INNER JOIN v_caja_aper AS c ON v.id_apc = c.id_apc WHERE (v.fec_ven >= ? AND v.fec_ven <= ?) AND v.pago_yape>0 AND v.estado = 'a' OR v.id_tpag ='5' GROUP BY v.id_ven ORDER BY DATE(v.fec_ven) ASC");
                $stm->execute(array($ifecha,$ffecha));    
            }
    ...
    public function venta_all_imp_($data)
    {
        ...
        {      
            ...
            $igv = $this->db->query("SELECT imp_val FROM tm_configuracion")->fetch(PDO::FETCH_OBJ);
            $valor_igv = $igv->imp_val;
            $valor_igv = 0.10;
            ...
            $c->{'Detalle'} = $this->db->query("SELECT v_productos.pro_cod AS codigo_producto, 
                CONCAT(v_productos.pro_pre) AS nombre_producto, /* DESCOMENTAR ESTA LINEA Y COMENTAR LA DE ABAJO EN CASO SE DESEE QUE SOLO SALGA LA PRESENTACION EN LA BOLETA */
                ...
                IF(v_productos.pro_imp='1',ROUND((tm_detalle_venta.precio/(1 + ".$valor_igv.")),2),tm_detalle_venta.precio) AS valor_unitario,
                tm_detalle_venta.precio AS precio_unitario,
                IF(v_productos.pro_imp='1',ROUND((tm_detalle_venta.precio/(1 + ".$valor_igv."))*tm_detalle_venta.cantidad,2),
                ROUND(tm_detalle_venta.precio*tm_detalle_venta.cantidad,2)) AS valor_venta,
                IF(v_productos.pro_imp='1',ROUND((tm_detalle_venta.precio/(1 + ".$valor_igv.")*tm_detalle_venta.cantidad)*".$valor_igv.",2),0) AS total_igv 
    ...
    public function finanza_arq_resumen_default($data)
    {
        try
        {    
            $stm = $this->db->prepare("SELECT v.id_apc,v.id_ped,IFNULL(SUM(v.pago_efe),0) AS pago_efe, IFNULL(SUM(v.pago_tar),0) AS pago_tar, IFNULL(SUM(v.pago_bil),0) AS pago_bil, IFNULL(SUM(v.pago_tra),0) AS pago_tra, IFNULL(SUM(v.pago_lin),0) AS pago_lin, IFNULL(SUM(v.desc_monto),0) AS descu, IFNULL(SUM(v.comis_tar),0) AS comis_tar, IFNULL(SUM(v.comis_del),0) AS comis_del, IFNULL(SUM(v.pago_efe+v.pago_tar+v.pago_bil+v.pago_tra+v.pago_lin),0) AS total, v.estado FROM v_ventas_con AS v LEFT JOIN tm_pedido_delivery AS d ON v.id_ped = d.id_pedido WHERE v.id_apc = ? AND v.estado <> 'i' AND (d.id_repartidor IS NULL OR d.id_repartidor = 1 OR d.id_repartidor > 2000)");
    ...
    public function finanza_arq_imp($data)
    {
        ...
        {      
            ...
            $c->{'Principal'} = $this->db->query("SELECT v.id_apc,v.id_ped,IFNULL(SUM(v.pago_efe),0) AS pago_efe, IFNULL(SUM(v.pago_tar),0) AS pago_tar, IFNULL(SUM(v.pago_bil),0) AS pago_bil, IFNULL(SUM(v.pago_tra),0) AS pago_tra, IFNULL(SUM(v.pago_lin),0) AS pago_lin, IFNULL(SUM(v.desc_monto),0) AS descu, IFNULL(SUM(v.comis_tar),0) AS comis_tar, IFNULL(SUM(v.comis_del),0) AS comis_del, IFNULL(SUM(v.pago_efe+v.pago_tar+v.pago_bil+v.pago_tra+v.pago_lin),0) AS total, IFNULL(SUM(v.total),0) AS gran_total, v.estado FROM v_ventas_con AS v LEFT JOIN tm_pedido_delivery AS d ON v.id_ped = d.id_pedido WHERE v.id_apc = {$data} AND v.estado <> 'i'")
            ->fetch(PDO::FETCH_OBJ);

            $c->{'Efectivo'} = $this->db->query("SELECT IF(v.id_tpag = 1 OR v.id_tpag = 3,SUM(v.pago_efe),0) AS total, COUNT(*) AS cant FROM v_ventas_con AS v LEFT JOIN tm_pedido_delivery AS d ON v.id_ped = d.id_pedido WHERE v.id_apc = {$data} AND v.estado <> 'i' AND (v.id_tpag = 1 OR v.id_tpag = 3)")
            ->fetch(PDO::FETCH_OBJ);

            $c->{'Ventas_Efectivo'} = $this->db->query("SELECT tp.descripcion, count(*) AS cantidad, SUM(v.pago_efe) AS monto FROM tm_venta AS v LEFT JOIN tm_tipo_pago AS tp ON tp.id_tipo_pago=v.id_tipo_pago WHERE v.id_apc = {$data} AND v.estado <> 'i' AND v.id_tipo_pago='1'")
            ->fetchAll(PDO::FETCH_OBJ); 
            ...
            */     
            ...
            $c->{'Glovo'} = $this->db->query("SELECT IFNULL(SUM(v.pago_efe + v.pago_tar + v.pago_bil + v.pago_tra + v.pago_lin),0) AS total, COUNT(*) AS cant FROM v_ventas_con AS v LEFT JOIN tm_pedido_delivery AS d ON v.id_ped = d.id_pedido WHERE v.id_apc = {$data} AND v.estado <> 'i' AND d.id_repartidor = 4444")
            ->fetch(PDO::FETCH_OBJ);

            $c->{'Rappi'} = $this->db->query("SELECT IFNULL(SUM(v.pago_efe + v.pago_tar + v.pago_bil + v.pago_tra + v.pago_lin),0) AS total, COUNT(*) AS cant FROM v_ventas_con AS v LEFT JOIN tm_pedido_delivery AS d ON v.id_ped = d.id_pedido WHERE v.id_apc = {$data} AND v.estado <> 'i' AND d.id_repartidor = 2222")
            ->fetch(PDO::FETCH_OBJ);

            $c->{'PedidosYa'} = $this->db->query("SELECT IFNULL(SUM(v.pago_efe + v.pago_tar + v.pago_bil + v.pago_tra + v.pago_lin),0) AS total, COUNT(*) AS cant FROM v_ventas_con AS v LEFT JOIN tm_pedido_delivery AS d ON v.id_ped = d.id_pedido WHERE v.id_apc = {$data} AND v.estado <> 'i' AND d.id_repartidor = 3333")
            ->fetch(PDO::FETCH_OBJ);
