    ...
    public function sendEmail($correo_cliente,$documento_cliente,$datos_factura,$negocio) {
        ...
        try {
            ...
            */
            ...
            $mail->Host = 'systemrest.host';
            $mail->SMTPAuth = true;

            $mail->Username = 'cpe@systemrest.host';
            ...
            ## MENSAJE A ENVIAR
            $mail->setFrom('cpe@systemrest.host', 'Alpharest.pe');
            ...
            <br>Le estamos adjuntando los archivos electrónicos "XML" y "PDF"</br>
            <br> ---------------------------------------------------------------------------------------</br>
