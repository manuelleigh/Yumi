        ...
        <div class="card">
            <div class="card-body p-0 display-two" style="display: block;">
                <ul class="nav nav-tabs customtab" role="tablist">
                    ...
                    <li class="nav-item"> <a class="nav-link list-ventas active" data-toggle="tab" href="#tab2" role="tab"><span class="hidden-sm-up">Lista de ventas</span> <span class="hidden-xs-down">Lista de notas de ventas</span></a> </li>
                </ul>
                <!-- Tab panes -->
