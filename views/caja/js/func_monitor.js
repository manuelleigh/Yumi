...
$(function() {
    ...
    .on('success.form.fv', function(e) {
        ...
        if ($("#editar_pago").val() != "") {
            if ($("#codigo_editar_pago").val() != $("#codigo_seguridad").val()) {
    ...
    fv = $form.data('formValidation');
        ...
        if ($("#editar_tipo_documento").val() != "") { 
            if ($("#codigo_editar_documento").val() != $("#codigo_seguridad").val()) {
                alert("Codigo ingresado no es valido");
                return false;
            } else {
                if ($("#cliente_id").val() == ''){
...
var ventas_list = function(id_apc){
    ...
    .DataTable({
        ...
            }},
	    	...
	    	{"data":"monto_neto","render": function ( data, type, row ) {
            ...
            {"data":null,"render": function ( data, type, row ) {
                if(data.estado !== 'a'){
                    ...
                    return '<div class="text-right"><div class="btn-group">'
                        +'<a href="javascript::void(0)" class="label label-success-3" id="new" data-toggle="dropdown" aria-expanded="false"><i data-feather="more-vertical" class="feather-sm"></i>Opciones</a>'
