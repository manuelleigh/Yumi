...
var lisTab1 = function(){
    ...
    .DataTable({
        ...
                    return '<span class="label label-primary">ENVIADO A SUNAT</span></a>';
                    ...
                    return '<span class="label label-warning-2">SIN ENVIAR</span></a></div>';
                }
            }},
            {"data":null,"render": function ( data, type, row ) {
                if(data.hash_cpe != ''){
            ...
            {"data":null,"render": function ( data, type, row ) {
                ...
                +'<i class="'+clase+'" style="font-height: bold; font-size: 20px;"></i><span class="label1 label-success-4">Opciones</span></button>'
