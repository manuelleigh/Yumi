            ...
            if(item.data.length > 0){
                $.each(item.data, function(i, campo) {
                    $('#ul-cat')
                        .append(
                        $('<li/>')
                            .html('<a href="javascript:void(0)" class="link" onclick="listarInsumos('+campo.id_catg+')">'+campo.descripcion+'&nbsp;<span class="label label-success-2">Ver insumos</span>'
    ...
    .DataTable({
      ...
          }
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="editarInsumo('+data.id_ins+')"><i data-feather="edit" class="feather-sm fill-white"></i>Edita insumo</a></div>';
            }}
        ]
    });
