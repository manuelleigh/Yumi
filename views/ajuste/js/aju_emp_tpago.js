...
var listar = function(){
  ...
            }
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="editar('+data.id_tipo_pago+');"><i data-feather="edit" class="feather-sm fill-white"></i>Editar</a></div>';
            }}
        ]
	});
