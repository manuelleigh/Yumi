...
var listar = function(){
    ...
    .DataTable({
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="usuario_edit/'+data.id_usu+'" class="text-info edit"><i data-feather="edit" class="feather-sm fill-white"></i>Editar</a>&nbsp;'
                    +'&nbsp;<a href="javascript:void(0)" class="text-danger delete ms-2" onclick="anular('+data.id_usu+','+data.id_rol+',\''+data.nombres+' '+data.ape_paterno+' '+data.ape_materno+'\');"><i data-feather="trash-2" class="feather-sm fill-white"></i>Eliminar</a></div>';
            }}
        ]
    });
