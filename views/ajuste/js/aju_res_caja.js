...
var listar = function(){
	...
	.DataTable({
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="editar('+data.id_caja+',\''+data.descripcion+'\',\''+data.estado+'\');"><i data-feather="edit" class="feather-sm fill-white"></i>Editar</a></div>';
            }}
        ]
	});
