      ...
            }
        ...
        "columns":[
            {"data":null,"render": function ( data, type, row) {
                return '<a href="javascript:void(0)" class="link-2" onclick="listarPresentaciones('+data.id_prod+',\''+data.nombre+'\')">'+data.nombre+'&nbsp;&nbsp;&nbsp;<span class="label label-success-2">Ver presentaciones</span></a>';
            }},
            {"data":null,"render": function ( data, type, row) {
                if(data.estado == 'a'){
        ...
        $('#body-c').html('<br><strong class="text-warning">Presentaciones de <span id="nomb_pres">'+nombre+'</span></strong><br><br>');
            if (item.data.length != 0) {
                ...
                $.each(item.data, function(i, campo) {
                    ...
                    $('#body-p')
                    .append(
                        $('<a href="javascript:void(0)" class="link-2" onclick="editarPresentacion('+campo.id_pres+',\''+nombre+'\')"/>')
                        .html('<div class="card col-sm-12 '+boxpres+' font-14" style="margin-bottom: 10px;"><div class="card-body d-flex" style="padding: 10px 0px 10px 0px;"><div class="read">'+campo.presentacion+'</div>&nbsp;&nbsp;&nbsp;<span class="label label-success-2">Editar</span><div class="ml-auto">'+moneda+' '+campo.precio+'</div></div></div>')
                    )
                });
            } else {
