        ...
        <div class="card">         
            <div class="card-body">
                <div class="message-box contact-box">
                    ...
                    <h2 class="add-ct-btn" id="step1"><button type="button" class="btn btn-circle btn-lg btn-orange waves-effect waves-dark btn-nuevo-categoria"><i class="ti-plus"></i>Añadir categoría</button></h2>
