        ...
        <div class="card">         
            <div class="card-body">
                <div class="message-box contact-box">
                    ...
                    <h2 class="add-ct-btn" id="step1"><button type="button" class="btn btn-circle btn-lg btn-orange waves-effect waves-dark btn-categoria-nuevo"><i class="ti-plus"></i>Añadir Categoría</button></h2>
                        ...
                        <div class="row" style="margin-bottom: -14px">
                            ...
                            <div class="col-sm-3">
                                <div class="text-right">
                                    <button type="submit" class="btn btn-sm btn-circle btn-orange"><i class="ti-plus"></i>añadir</button>
