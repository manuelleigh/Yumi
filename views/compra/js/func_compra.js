...
var listar = function(){
	...
	.DataTable({
        ...
                    return '<div class="text-center"><span class="label label-success">APROBADO</span></div>';
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="detalle('+data.id_compra+');"><i data-feather="eye" class="feather-sm fill-white"></i>Ver items</a>'
                    +'&nbsp;&nbsp;<a href="javascript:void(0)" class="text-danger delete ms-2" onclick="anular('+data.id_compra+',\''+data.desc_td+' '+data.serie_doc+'-'+data.num_doc+'\',\''+data.total+'\');"><i data-feather="trash-2" class="feather-sm fill-white"></i>Eliminar</a></div>';
            }}
		],
