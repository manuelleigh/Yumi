        ...
        <div class="card">
            <div class="card-body p-b-0">
                <div class="message-box contact-box">
                    <h2 class="add-ct-btn">
                        <a href="<?php echo URL; ?>compra/nueva-compra"><button type="button" class="btn btn-circle btn-lg btn-orange waves-effect waves-dark"><i class="ti-plus"></i>Añadir Compra</button></a>
                    </h2>
                    <br>
