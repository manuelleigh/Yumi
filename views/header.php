...
<head>
    ...
    <?php
        ...
        {
            echo '<title>Yumi | '.$this->title_page.'</title>';
        }
        else{
            echo '<title>Yumi</title>';
        }
    ?>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    ...
                    <?php } ?>
                        <!-- Logo icon -->
                        <b>
                            <!-- <img src="<?php echo URL; ?>public/images/icon-insaga-rest.png" width="35px"/> -->
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
                        <!-- <img src="<?php echo URL; ?>public/images/logo-alpharest-header.png"/> -->
                            <span class="font-18 font-medium text-white">Yumi</span> <span class="font-18 font-medium text-white">.Net</span>
                        </span>
                    </a>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <a href="<?php echo URL;?>venta"><button class="btn btn-accesos-rapidos waves-effect waves-light border-0" type="button"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-pos.png" width="20px" height="20px"/>MESAS</span></button></a>
                        <?php } ?>
                        <?php if((Session::get('rol') == 1 OR Session::get('rol') == 2 OR Session::get('rol') == 3) AND Session::get('sunat') == 1) { ?>
                        <a href="<?php echo URL;?>caja/apercie"><button class="btn btn-accesos-rapidos waves-effect waves-light border-0" type="button"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-caja-chica.png" width="20px" height="20px"/>CAJA CHICA</span></button></a>
                        <?php } ?>
                        <?php if((Session::get('rol') == 1 OR Session::get('rol') == 2 OR Session::get('rol') == 3) AND Session::get('sunat') == 1) { ?>
                        <a href="<?php echo URL;?>informe/finanza_arq"><button class="btn btn-accesos-rapidos waves-effect waves-light border-0" type="button"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-info-caja.png" width="20px" height="20px"/>INFO CAJA</span></button></a>
                        <?php } ?>
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <?php } ?>                       
                            <?php if((Session::get('rol') == 1 OR Session::get('rol') == 2 OR Session::get('rol') == 3) AND Session::get('sunat') == 1) { ?>
                            <a href="<?php echo URL; ?>caja/monitor?menu=superior"><button class="btn btn-accesos-rapidos waves-effect waves-light border-0" type="button"><span class="btn-label0"><img src="<?php echo URL; ?>public/images/icono-pos.png" width="20px" height="20px"/>Monitor de Ventas</span></button></a>
                            <?php } ?>
                            <?php if((Session::get('rol') == 1 OR Session::get('rol') == 2 OR Session::get('rol') == 3) AND Session::get('sunat') == 1) { ?>
