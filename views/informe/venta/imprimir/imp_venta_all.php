...
$pdf->Cell(72,4,'RUC'.utf8_decode(Session::get('tribAcr')).': '.utf8_decode($this->empresa['ruc']),0,1,'C');
...
$pdf->Cell(15, 10, number_format(((($this->dato->total - $this->dato->desc_monto) +$this->dato->comis_del) / $valor_igv),2),0,0,'R')	;
/* fin  */
$pdf->Ln(4);
...
$pdf->Cell(15, 10, number_format(((($this->dato->total- $this->dato->desc_monto) +$this->dato->comis_del) - ((($this->dato->total - $this->dato->desc_monto) +$this->dato->comis_del) / $valor_igv)),2),0,0,'R');
...
if ($this->dato->pago_mastercard > 0){
	$pdf->Ln(4);
	$pdf->Cell(37, 10, 'MASTERCARD', 0);    
	$pdf->Cell(20, 10, '', 0);
	$pdf->Cell(15, 10, number_format(($this->dato->pago_mastercard),2),0,0,'R');
}
if ($this->dato->pago_visa > 0){
	$pdf->Ln(4);
	$pdf->Cell(37, 10, 'VISA', 0);    
	$pdf->Cell(20, 10, '', 0);
	$pdf->Cell(15, 10, number_format(($this->dato->pago_visa),2),0,0,'R');
}
if ($this->dato->pago_tra > 0){
	$pdf->Ln(4);
	$pdf->Cell(37, 10, 'TRANSFERENCIA', 0);    
	$pdf->Cell(20, 10, '', 0);
	$pdf->Cell(15, 10, number_format(($this->dato->pago_tra),2),0,0,'R');
}		
if ($this->dato->pago_lin > 0){
	$pdf->Ln(4);
	$pdf->Cell(37, 10, 'CULQI', 0);    
	$pdf->Cell(20, 10, '', 0);
	$pdf->Cell(15, 10, number_format(($this->dato->pago_lin),2),0,0,'R');
}
if ($this->dato->pago_lukita > 0){
	$pdf->Ln(4);
	$pdf->Cell(37, 10, 'LUKITA', 0);    
	$pdf->Cell(20, 10, '', 0);
	$pdf->Cell(15, 10, number_format(($this->dato->pago_lukita),2),0,0,'R');
}
...
if ($this->dato->pago_tunki > 0){
	$pdf->Ln(4);
	$pdf->Cell(37, 10, 'TUNKI', 0);    
	$pdf->Cell(20, 10, '', 0);
	$pdf->Cell(15, 10, number_format(($this->dato->pago_tunki),2),0,0,'R');
}
