        ...
        <div class="card-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 p-10 align-self-center">
                                    <div class="d-flex m-l-20">
                                        <div class="display-7 text-mute"><i class="ti ti-credit-card"></i></div>
                                        <div class="m-l-10">
                                            <h4 class="font-regular text-mute m-b-0 c-monto-billeteras"></h4>
                                            <small>Billeteras Digitales</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card">
                <ul class="nav nav-tabs customtab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/informe/finanza_arq_imp/<?php echo $this->apc; ?>" target="_blank" role="tab" aria-selected="false"><span class="hidden-sm-up"><i data-feather="printer" class="feather-sm fill-white"></i> Imprimir Caja</span> <span class="hidden-xs-down  btn-imp-caja"><i data-feather="printer" class="feather-sm fill-white"></i> Imprimir Caja</span></a>
                    </li>                    
                    <!--
                    <li class="nav-item">
