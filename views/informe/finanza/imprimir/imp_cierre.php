...
/*
$pdf->Cell(32, 4, 'IZIPAY', 0);   
$pdf->Cell(15, 4, $this->dato->Ventas_IZIPAY[0]->cantidad,0,0,'R');
$pdf->Cell(25, 4, number_format(($this->dato->Ventas_IZIPAY[0]->monto),2),0,0,'R');
$pdf->Ln(4);
*/
...
$pdf->Cell(25, 4, '= '.number_format(($this->dato->Principal->gran_total),2),0,0,'R');
$pdf->Ln(4); 
...
$pdf->Cell(15, 4, $totalCantVentas - $this->dato->Anulaciones->cant,0,0,'R');
$pdf->Cell(25, 4, '= '.number_format(($this->dato->Principal->gran_total) - ($this->dato->Anulaciones->total),2),0,0,'R');
