...
var defaultdata = function(){
    $.ajax({
        ...
        success: function (item) {
            ...
            var montoEfectivo = (parseFloat(totalIng) - (parseFloat(item.pago_tar) + parseFloat(item.pago_bil) + parseFloat(item.pago_tra) + parseFloat(item.pago_lin))) - parseFloat(totalEgr).toFixed(2);
            ...
            $(".c-monto-billeteras").html(moneda+' '+formatNumber(item.pago_bil));
