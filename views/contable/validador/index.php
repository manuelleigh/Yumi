                ...
                <div class="message-box contact-box">
                    ...
                    <div class="row floating-labels m-t-5">
                        ...
                        <div class="col-md-6 col-lg-2">
                            <div class="form-group m-b-40">
                                <input type="text" name="num_inicial" id="num_inicial" minlength="8" maxlength="8" class="form-control" autocomplete="off" required>
                                <span class="bar"></span>
                                <label for="trib_acr">Numero inicial</label>
                            </div>
                        </div>   
                        <div class="col-md-6 col-lg-2">
                            <div class="form-group m-b-40">
                                <input type="text" name="num_final" id="num_final" maxlength="8" class="form-control" autocomplete="off" required>
                                <span class="bar"></span>
                                <label for="trib_acr">Numero final</label>
                            </div>
                        </div>                       
