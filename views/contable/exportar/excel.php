...
<table id="bootstrap-table">
    <tr>
    <td colspan="<?php print $col_span; ?>" class="text-center font-weight"> RAZÓN SOCIAL: <?php print(utf8_decode($this->Empresa['razon_social'])); ?></td>
    </tr>
    <tr>
        <td colspan="<?php print $col_span; ?>" class="text-center font-weight"> RAZÓN SOCIAL: <?php print(utf8_decode($this->Empresa['nombre_comercial'])); ?></td>
    </tr>
    <tr>
    ...
    ?>
     <tr>
            ...
            if ($row->estado == 'i') : 
                ...
                $total_exportation = '0';
                $total_taxed = $total_ope_gravadas - number_format((($descuento/$valor_igv)), 2, ".", "");
                $total_exonerated = ($total_ope_exoneradas > 0 )? ($total_ope_exoneradas + $comision_delivery) : '0';
                //$total_exonerated = $total_ope_exoneradas + $comision_delivery;
                $total_unaffected = '0';
                $total_plastic_bag_taxes = '0';    
                $total_igv = $total_igv_gravadas - number_format(($descuento -($descuento/$valor_igv)), 2, ".", "");
