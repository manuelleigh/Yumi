                ...
                <div class="scroll_pedidos">
                    <div class="cont01 justify-center" style="height: 100%;">
                        ...
                        <div class="text-center cont01-2" style="display: none;">
                            <h2 class="text-white"><button type="button" class="btn btn-circle btn-lg btn-orange waves-effect waves-dark btn-nuevo-pedido"><i class="ti-plus"></i>Añadir</button></h2>
