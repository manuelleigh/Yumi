...
<br>  
<div class="row u4-1">
<ul class="scroll_horizontal nav nav-tabs" id="list-catgrs">
    </ul>
                    ...
                    <div class="row p-l-0">
                        ...
                        <div class="col-md-7 p-t-20" style="background: #fbfdff;">
                            ...
                            <div class="col-lg-12 p-t-10 p-b-10">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend display-pago-efectivo box-tipo-pago">
                                        <span class="input-group-text bg-white">
                                            <small class="text-left">EFECTIVO</small>
                                            <div class="row">
                                                <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                                <input type="text" class="form-control form-control-lg" maxlength="9" placeholder="0.00" autocomplete="off" name="pago_efe" id="pago_efe">
                                            </div>
                                        </span>
                                    </div>
                                    
                                    <div class="input-group-prepend display-pago-tarjeta box-tipo-pago">
                                        <span class="input-group-text bg-white">
                                            <small class="text-left">TARJETA</small>
                                            <div class="row">
                                                <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                                <input type="text" class="form-control form-control-lg" maxlength="9" placeholder="0.00" autocomplete="off" name="pago_tar" id="pago_tar" value="0" readonly>
                                            </div>                                            
                                        </span>
                                    </div>

                                    <div class="input-group-prepend display-pago-billetera box-tipo-pago">
                                        <span class="input-group-text bg-white">
                                            <small class="text-left">BILLETERA DIGITAL</small>
                                            <div class="row">
                                                <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                                <input type="text" class="form-control form-control-lg" maxlength="9" placeholder="0.00" autocomplete="off" name="pago_bil" id="pago_bil" value="0" readonly>
                                            </div>                                            
                                        </span>
                                    </div>                                    

                                    <div class="input-group-prepend display-pago-transferencia box-tipo-pago">
                                        <span class="input-group-text bg-white">
                                            <small class="text-left">TRANSFERENCIA</small>
                                            <div class="row">
                                                <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                                <input type="text" class="form-control form-control-lg" maxlength="9" placeholder="0.00" autocomplete="off" name="pago_tra" id="pago_tra" value="0">
                                            </div>                                            
                                        </span>
                                    </div>
                                    
                                    <div class="input-group-prepend display-pago-linea box-tipo-pago">
                                        <span class="input-group-text bg-header">
                                            <small class="text-left">EN LINEA</small>
                                            <div class="row">
                                                <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                                <input type="text" class="form-control form-control-lg" maxlength="9" placeholder="0.00" autocomplete="off" name="pago_lin" id="pago_lin" value="0">
                                            </div>
                                        </span>
                                    </div>
                            ...
                            <div class="col-lg-12 p-t-10 p-b-10 display-tipo-pago">
                                <?php
                                $listaTipoPago = $this->TipoPago;
                                ?>   
                                <div class="row">
                                    <div class="col-5">
                                        <div class="col-12 text-white m-b-5" style="background: #75cfb8;">TARJETAS</div>
                                        <ul class="tipo_pago">
                                        <?php
                                        foreach ($listaTipoPago as $key => $value) {
                                            ...
                                            if ($id_pago == 2) {
                                                ...
                                                echo '<li><input type="checkbox" value="' . $id_tipo_pago . '" name="tarjetasID[]" id="chk' . $id_tipo_pago . '" class="chk-col-green"><label for="chk' . $id_tipo_pago . '">' . $descripcion . '</label><div class="item"><div class="text-left font-medium">' . Session::get('moneda') . '</div><input type="text" class="form-control form-control-lg pago_' . $id_pago .'" maxlength="9" placeholder="0.00" autocomplete="off" name="tarjetasMontos[]" value="0" data-tp="' . $id_tipo_pago . '"></div></li>';
                                            }
                                        }
                                        ?>
                                        </ul>
                                    ...
                                    <div class="col-7">
                                        <div class="col-12 text-white m-b-5" style="background: #75cfb8;">BILLETERA DIGITAL</div>
                                        <ul class="tipo_pago">
                                        <?php
                                        foreach ($listaTipoPago as $key => $value) {
                                            $id_pago = $value['id_pago'];
                                            ...
                                            if ($id_pago == 7) {
                                                ...
                                                echo '<li><input type="checkbox" value="' . $id_tipo_pago . '" name="billeterasID[]" id="chk' . $id_tipo_pago . '" class="chk-col-green"><label for="chk' . $id_tipo_pago . '">' . $descripcion . '</label><div class="item"><div class="text-left font-medium">' . Session::get('moneda') . '</div><input type="text" class="form-control form-control-lg pago_' . $id_pago .'" maxlength="9" placeholder="0.00" autocomplete="off" name="billeterasMontos[]" value="0" data-tp="' . $id_tipo_pago . '"></div></li>';
                                            }
                                        }
                                        ?>
                                        </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 display-codigo-operacion">
...
<script id="nvo-ped-det-template" type="text/x-jsrender" src="">
    ...
    <tr class="warning-element" style="border-left: 2px solid #ffb22b !important; background: #fefde3;" data-id-row="{{:area_id}}-{{:producto_id}}">
        <td style="width: 110px !important;position: relative;z-index: 0;">
            ...
            <input class="touchspin1 input-sm text-left" type="text" value="{{:cantidad}}" name="cantidad" data-bts-button-down-class="btn btn-warning" data-bts-button-up-class="btn btn-warning" data-bts-min="1" data-bts-max="{{:disponible}}" data-bts-step="1" data-bts-booster="false" data-bts-step-interval-delay="600000" onchange="pedido.actualizar({{:id}}, this);" />
        </td>
        ...
        <td class="text-right m-l-0" style="width: 90px !important;">
            <button type="button" class="btn btn-sm waves-effect waves-light btn-outline-info mb-2" onclick="comentar({{:id}},{{:producto_id}},'{{:producto}}','{{:presentacion}}');"><i class="fas fa-comment-alt"></i></button>
