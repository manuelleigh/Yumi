            ...
            $.each(data.Detalle, function(i, item) {
                ...
                if (item.estado != 'z'){
                    ...
                    .append(
                        ...
                        +'<input id="cantidad_eliminar" type="number" value="'+item.cant+'" step="1" min="1" max="'+item.cant+'" onInput="this.value = this.value.slice(0, 2)" style="width: 45px; margin-right:5px;">'
            ...
            return new Promise(function(resolve) {
                $.ajax({
                    ...
                    data: {
                        id_pedido : id_pedido,
                        id_pres : id_pres,
                        cantidad_eliminar : $("#cantidad_eliminar").val(),
